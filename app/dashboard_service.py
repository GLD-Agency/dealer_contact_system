...
class DashboardService:
    ...
    def capture_snapshot(self) -> None:
        ...
        SELECT
          ...
          (SELECT COUNTIF(activation_status = 'activation_ready') FROM `{self.settings.prospect_contacts_table_fqn}`),
    ...
    def _get_overview(self) -> dict[str, Any]:
        ...
        SELECT
          ...
          (SELECT COUNTIF(activation_status = 'activation_ready') FROM `{self.settings.prospect_contacts_table_fqn}`) AS activation_ready_contacts,
