...
def get_settings() -> Settings:
    ...
    return Settings(
        ...
        gld_accountability_project_id=os.getenv("GLD_ACCOUNTABILITY_PROJECT_ID", "gld-accountability-platform"),
        client_dim_dataset=os.getenv("CLIENT_DIM_DATASET", ""),
        client_dim_table=os.getenv("CLIENT_DIM_TABLE", ""),
        client_dim_enabled=os.getenv("CLIENT_DIM_ENABLED", "false").lower() == "true",
        client_dim_client_id_column=os.getenv("CLIENT_DIM_CLIENT_ID_COLUMN", "client_id"),
        client_dim_account_owner_column=os.getenv("CLIENT_DIM_ACCOUNT_OWNER_COLUMN", "account_owner"),
        client_dim_account_key_column=os.getenv("CLIENT_DIM_ACCOUNT_KEY_COLUMN", "account_key"),
        client_dim_domain_column=os.getenv("CLIENT_DIM_DOMAIN_COLUMN", "normalized_domain"),
        client_dim_name_column=os.getenv("CLIENT_DIM_NAME_COLUMN", "dealer_name"),
        client_dim_city_column=os.getenv("CLIENT_DIM_CITY_COLUMN", "city"),
        client_dim_state_column=os.getenv("CLIENT_DIM_STATE_COLUMN", "state"),
        client_dim_email_domain_column=os.getenv("CLIENT_DIM_EMAIL_DOMAIN_COLUMN", "email_domain"),
        client_dim_email_column=os.getenv("CLIENT_DIM_EMAIL_COLUMN", "email"),
        client_dim_current_client_flag_column=os.getenv("CLIENT_DIM_CURRENT_CLIENT_FLAG_COLUMN", "is_current_client"),
    )
