param(
  ...
  [string]$DomainDiscoverySecondaryJobName = "dealer-domain-discovery-worker-secondary",
  [string]$DomainDiscoverySecondarySchedulerName = "dealer-domain-discovery-worker-secondary-schedule",
...
$envVars = @(
  ...
  "DOMAIN_DISCOVERY_SECONDARY_JOB_NAME=$DomainDiscoverySecondaryJobName"
  "DOMAIN_DISCOVERY_SECONDARY_SCHEDULER_NAME=$DomainDiscoverySecondarySchedulerName"
