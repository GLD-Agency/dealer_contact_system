param(
    ...
    [string]$ValidateSchedule = "*/30 * * * *",
    [string]$CrawlSchedule = "*/15 * * * *",
    [string]$GbpSchedule = "*/30 * * * *",
    [string]$AiSchedule = "*/30 * * * *",
    [string]$ContactExtractSchedule = "*/15 * * * *",
    [string]$BlockedRetrySchedule = "*/30 * * * *",
    [string]$LeadRefreshSchedule = "*/15 * * * *",
